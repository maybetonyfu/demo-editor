...
const File = ({path}) => {
    let [, open] = useAtom(openFile);
    return (<div
        onClick={async () => {
            open(path)
        }} 
        className="flex bg-stone-200 px-2 py-0.5 items-center cursor-pointer">
...
const Folder = ({path}) => (
    <div className="flex bg-stone-200 px-2 py-0.5 items-center cursor-pointer">
